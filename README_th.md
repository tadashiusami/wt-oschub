...
แชร์ URL ของ Web Client และ Session ID ที่ไม่ซ้ำกันกับผู้เข้าร่วมทุกคน Session ID ต้องไม่เกิน 64 ตัวอักษร
