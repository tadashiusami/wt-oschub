...
- Node.js (để chạy local bridge)
- Trình duyệt web hiện đại hỗ trợ WebTransport: Chrome 97+, Edge 98+, Firefox 115+, Opera 83+ (Safari hiện chưa được hỗ trợ)
...
├── client-web/
│   └── index.html         # Giao diện web client (HTML/JS)
├── .gitignore
├── LICENSE                # GNU GPL v3
└── README.md
```
...
Chia sẻ URL Web Client và Session ID duy nhất với tất cả người tham gia.
